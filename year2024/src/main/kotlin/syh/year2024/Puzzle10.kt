...
class Puzzle10 : AbstractAocDay(2024, 10) {
    ...
    private fun walkToEnding(currentNode: Node, graph: MutableList<MutableList<Node>>): Set<Node> {
    ...
    private fun walkDistinctPath(currentNode: Node, graph: MutableList<MutableList<Node>>): Int {
        println("walking node $currentNode")
        if (currentNode.height.toIntOrNull() == 9) {
            return 1
        }
