...
class Puzzle16 : AbstractAocDay(2023, 16) {
    ...
    override fun doA(file: String): String {
        ...
        val grid: MutableList<MutableList<CaveFloor>> = mutableListOf()
    ...
    private fun countEnergizedCells(grid: MutableList<MutableList<CaveFloor>>) = grid.sumOf { row -> row.count { it.energized } }

    private fun cloneGrid(grid: MutableList<MutableList<CaveFloor>>): MutableList<MutableList<CaveFloor>> {
    ...
    private fun traverseEnergyPath(grid: MutableList<MutableList<CaveFloor>>, startPair: Pair<CaveFloor, String>) {
...
//            println("Previously handled ${currentFloor.toCoordString()} with type ${currentFloor.type} in direction $currentDirection")
    ...
    private fun findNeighbours(caveFloor: CaveFloor, originDirection: String, grid: MutableList<MutableList<CaveFloor>>): List<Pair<CaveFloor, String>> {
    ...
    private fun findNeighbourForEmptyCaveFloor(
        ...
        grid: MutableList<MutableList<CaveFloor>>
