...
fun main() {
    val lines = readSingleLineFile("year2023/day18/actual.txt")

    println("part a:")
    calculateTotalArea(lines) { line -> lineParserPartA(line) }
    println("part b:")
    calculateTotalArea(lines) { line -> lineParserPartB(line) }
...
private fun calculateTotalArea(lines: List<String>, lineParser: Function<String, Pair<String, Long>>) {
